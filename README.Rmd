...
The goal of PL4DC is to to assist in data cleansing tasks. The functions contained are focused on improving one or more of the quality properties defined in ISO/IEC 25024.
